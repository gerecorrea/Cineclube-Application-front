						...
						>
							<template slot="table-row" slot-scope="props">
								...
								<span v-else-if="props.column.field == 'watchlist'">
									<div v-if="props.row.watchlist" class="mdi mdi-checkbox-marked-circle-outline md-color-green-800" uk-tooltip="Adicionado à watchlist">
									</div>
							...
							<div slot="emptystate" class="uk-text-center uk-text-large">
								<span>Não há filmes favoritados em seu perfil ou para esta busca.</span>
							</div>	
						</VueGoodTable>
					</fieldset>
				</ScCardBody>
...
export default {
	...
	methods: {
		...
		listFavorites () {
			...
			UserMovieRelation.findFavoritesUserByMovieType(this.loggedUserObject.uuid, 'DOCUMENTARY')
				.then(response => {
